        ...
        <div className='pt-24 md:pt-28 pb-10 container'>
            ...
            <div className='grid grid-cols-12 gap-4'>
                ...
                <section className='card overflow-hidden relative col-span-12 md:col-span-7 flex flex-col'>
                    ...
                    <span className="absolute w-80 h-80 bg-sky-400/10 dark:bg-sky-900/10 -bottom-20 -right-44 rotate-[50deg] rounded-[3rem]"></span>
                    <span className="absolute w-[35rem] h-72 bg-blue-300/[.05] dark:bg-blue-950/10 -bottom-10 -right-40 -rotate-[20deg] rounded-[2rem]"></span>
            ...
            <div className="grid grid-cols-12 gap-4 mt-4">
                <section className="card overflow-hidden col-span-12 md:col-span-7 relative">
                    ...
                    <span className="absolute w-80 h-80 bg-sky-400/10 dark:bg-sky-900/10 -bottom-20 -left-44 rotate-[50deg] rounded-[3rem]"></span>
                    <span className="absolute w-[35rem] h-72 bg-blue-300/[.05] dark:bg-blue-950/10 -bottom-10 -left-40 rotate-[30deg] rounded-[2rem]"></span>
                ...
                <span className="absolute w-40 h-56 bg-sky-400/[.05] dark:bg-sky-900/10 blur-xl -top-12 -left-14 rotate-[65deg] rounded-[1.5rem]"></span>
                <span className="absolute w-80 h-80 bg-sky-400/10 dark:bg-sky-900/10 -bottom-10 -right-56 rotate-[35deg] rounded-[3rem]"></span>
                <span className="absolute w-[35rem] h-80 bg-blue-300/[.05] dark:bg-blue-950/10 bottom-10 -right-64 -rotate-[40deg] rounded-[2rem]"></span>
            ...
            <section className="card overflow-hidden col-span-12 mt-2 grid grid-cols-12 gap-4 p-4 relative">
                <span className="absolute w-20 h-52 bg-sky-400/10 dark:bg-sky-900/10 -top-10 -left-12 rotate-[50deg] rounded-[1rem]"></span>
                <span className="absolute w-[35rem] h-44 bg-blue-300/[.05] dark:bg-blue-950/10 -top-10 -left-40 -rotate-[20deg] rounded-[2rem]"></span>
                <FormTypeRoom/>
            </section>
            <Formlandmark/>
            <div className="mt-8">
